...
namespace XEP_EsaModelData.Infrastructure
{
    ...
    {
        // General
        public static readonly string s_KeyIO = "IO";
        public static readonly string s_KeyID = "ID";
        public static readonly string s_KeyDx = "Dx";
        public static readonly string s_KeyMember = "Member";
        public static readonly string s_KeySection = "Section";
        public static readonly string s_KeyLength = "Length";
        public static readonly string s_KeyMaterial = "Material";
        public static readonly string s_KeyType = "Type";

        // Load
        public static readonly string s_KeyLoad = "Load";
        public static readonly string s_KeyLoadID = "ID";
        public static readonly string s_KeyLoadType = "Type";
        public static readonly string s_KeyLoadLimitState = "LimitState";
        public static readonly string s_KeyLoadCombiKey = "CombiKey";
        public static readonly string s_KeyLoadCombiType = "CombiType";

        // InternalForces
        public static readonly string s_KeyInternalForces = "InternalForces";
        public static readonly string s_KeyInternalForcesID = "ID";
        public static readonly string s_KeyInternalForcesN = "N";
        public static readonly string s_KeyInternalForcesMy = "My";
        public static readonly string s_KeyInternalForcesMz = "Mz";
        public static readonly string s_KeyInternalForcesMx = "Mx";
        public static readonly string s_KeyInternalForcesVy = "Vy";
        public static readonly string s_KeyInternalForcesVz = "Vz";
        public static readonly string s_KeyInternalForcesIsCritical = "IsCritical";
