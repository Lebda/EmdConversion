...
{
    internal class XEP_EmdLine : IXEP_EmdLine
    {
        public XEP_EmdLine()
        {
            LineIndex = 0;
            IntendationLevel = 0;
            Name = String.Empty;
            Attributes = new List<IXEP_EmdAttribute>();
            Lines = new List<IXEP_EmdLine>();
        }
        ...
        public List<IXEP_EmdAttribute> Attributes { get; set; }
        public List<IXEP_EmdLine> Lines { get; set; }
        #endregion
